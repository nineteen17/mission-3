...
//   it('should return an error for an invalid year', () => {
//     const input = { model: 'Camry', year: '123' };
//     const output = calculateCarValue(input);
//     expect(output).toEqual({ error: 'there is an error' });
//   });
});
